...
public class ImporterTest {
    ...
    public Object[][] getExcel() throws URISyntaxException {
        ...
        return new Object[][]{
                ...
                {getFile("excel.csv"), "FakePojo{one='ABC', two='DEF', three='GHI'}FakePojo{one='XXX', two='', three='XXX'}"}
        };
    }
    ...
    public void test(File file, String result) throws Exception {
        List<FakePojo> pojos = new Importer<FakePojo>(FakePojo.class, file).parse();
