...
public class ExporterFormatterTest {
    ...
    private Object[][] exporterFormatterDs() throws ParseException {
        return new Object[][]{
                { Locale.ENGLISH, ExporterFormatter.ENGLISH, DATETIME_FORMAT.parse("2016-02-28T15:45:46"), "Feb 28, 2016 3:45:46 PM", DATE_FORMAT.parse("2016-02-28"), "Feb 28, 2016", TIME_FORMAT.parse("15:45:46"), "3:45 PM", 12025.5, "12,025.5", "$12,025.50"},
                { Constants.LOCALE_PT_BR, ExporterFormatter.BRAZILIAN, DATETIME_FORMAT.parse("2016-02-28T15:45:46"), "28/02/2016 15:45:46", DATE_FORMAT.parse("2016-02-28"), "28/02/2016", TIME_FORMAT.parse("15:45:46"), "15:45", 12025.5, "12.025,5", "R$ 12.025,50"},
                { Locale.ENGLISH, ExporterFormatter.ENGLISH, DATETIME_FORMAT.parse("2016-02-28T15:45:46"), "Feb 28, 2016 3:45:46 PM", DATE_FORMAT.parse("2016-02-28"), "Feb 28, 2016", TIME_FORMAT.parse("15:45:46"), "3:45 PM", 12025, "12,025", "$12,025.00"},
                { Constants.LOCALE_PT_BR, ExporterFormatter.BRAZILIAN, DATETIME_FORMAT.parse("2016-02-28T15:45:46"), "28/02/2016 15:45:46", DATE_FORMAT.parse("2016-02-28"), "28/02/2016", TIME_FORMAT.parse("15:45:46"), "15:45", 12025, "12.025", "R$ 12.025,00"},
